                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="space-y-32">
                        ...
                        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
                            <div className="relative aspect-square w-full max-w-md mx-auto lg:mx-0 overflow-hidden rounded-xl bg-white shadow-2xl flex items-center justify-center p-12">
                                <Image
                                    src="/images/logo-guardian-gym.jpg"
                                    alt="Guardian Gym Oakland Logo"
                                    fill
                                    unoptimized
                            ...
                            <div>
                                ...
                                <div className="mt-8 space-y-6 text-lg font-medium leading-relaxed text-guardian-black/60">
                                    <p>
                                        Founded in 2015 in Oakland, California, Guardian Gym pioneered the 501(c)(3) model of providing free, elite martial arts training to youth who need it most.
                                    </p>
                                    <p>
                        ...
                        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-24">
                            ...
                            <div className="order-1 lg:order-2 relative aspect-square w-full max-w-md mx-auto lg:ml-auto overflow-hidden rounded-xl bg-guardian-black shadow-2xl flex items-center justify-center p-12">
                                <Image
